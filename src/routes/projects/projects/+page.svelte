...
<!-- BAND: challenges -->
<div class="band band-challenges"></div>

<!-- SECTION 1: LOCAL CHALLENGES -->
<section class="dark-section" id="local-challenges">
...
<style>
	...
	.band-partners {
		background: linear-gradient(to right, #22395c, #f9ba47, #22395c);
	}

	.band-impact {
		background: linear-gradient(to right, #22395c, #9b372f, #22395c);
	}

	.band-donate {
		background: linear-gradient(to right, #22395c, #da7939, #22395c);
	}
