...
const pages = [
	...
	{ path: '/foundation', changefreq: 'monthly', priority: '0.8' },
	{ path: '/foundation/projects', changefreq: 'monthly', priority: '0.8' },
	{ path: '/foundation/impact', changefreq: 'monthly', priority: '0.7' },
	{ path: '/foundation/donate', changefreq: 'monthly', priority: '0.8' },
	{ path: '/programmes', changefreq: 'monthly', priority: '0.9' },
	{ path: '/programmes/volunteering', changefreq: 'monthly', priority: '0.8' },
	{ path: '/programmes/internships', changefreq: 'monthly', priority: '0.8' },
	{ path: '/programmes/sabbatical', changefreq: 'monthly', priority: '0.8' },
